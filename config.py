...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", -1003348312770))
...
API_KEY = getenv("API_KEY", 'NxGBNexGenBotsbb404a') # youtube song api ke 
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/theminilovingworld")
SUPPORT_GROUP = getenv("SUPPORT_GROUP", "https://t.me/+8Ju1wTIH34gyZjll")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://files.catbox.moe/0vo088.jpg"
)
PING_IMG_URL = getenv(
